...
const styles = (theme) => {
  return {
    ...
    StatisticsBar: {
      backgroundImage:
        "url(https://static.wixstatic.com/media/82fcd3_7a9abf1cf93845128c7233ec2618ee98~mv2.jpg/v1/fill/w_1423,h_540,al_c,q_85,enc_auto/82fcd3_7a9abf1cf93845128c7233ec2618ee98~mv2.jpg)",
      paddingTop: 65,
