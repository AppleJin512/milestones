...
import { Alert, LinearProgress, InputLabel, Select, TextField, FormControl, MenuItem, 
         Paper, Breadcrumbs, Container, Box, Grid, Button } from '@mui/material';
...
export default function () {
    ...
    const breadcrumbs = [
        <Link underline="hover" key="1" color="inherit" to="/" onClick={handleClick}>
            HOME
        </Link>,
        <Link
            underline="hover"
    ...
    const ShowItems = () => {    
        if (pic.top_button_name && pic.bottom_button_name) {
            return (
                    <Container maxWidth="lg" style={{position: 'absolute', top: '23%'}} data-aos="zoom-y-out">
                        <Box className={classes.top_button_box}>
                            <Button variant='contained' className={classes.top_button}>{pic.top_button_name}</Button>
                        </Box>
                        <Box className={classes.bottom_button_box}>
                            <Button variant='contained' className={classes.bottom_button}>{pic.bottom_button_name}</Button>
                        </Box>
                    </Container>
            )
        }
    ...
    return (
        <div className='container mx-auto max-w-screen-md mb-10' style={{paddingTop: 70}}>
